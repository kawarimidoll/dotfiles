...
augroup min-edit
  ...
  autocmd FileType markdown setlocal comments=nb:>
        \ comments+=b:*\ [\ ],b:*\ [x],b:*
        \ comments+=b:+\ [\ ],b:+\ [x],b:+
        \ comments+=b:-\ [\ ],b:-\ [x],b:-
        \ comments+=b:1.\ [\ ],b:1.\ [x],b:1.
        \ formatoptions-=c formatoptions+=jro
  autocmd FileType markdown nnoremap <buffer> <C-CR> <Cmd>MarkdownCheckbox<CR>
  autocmd FileType markdown inoremap <buffer> <C-CR> <Cmd>MarkdownCheckbox<CR>
  autocmd FileType markdown xnoremap <buffer> <C-CR> <Cmd>MarkdownCheckbox<CR>
