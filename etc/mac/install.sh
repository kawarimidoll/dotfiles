...
echo "  (for Intel chip Mac) ln -sf \$DOT_DIR/etc/mac \"$(brew --prefix)/opt/coreutils/libexec/gnubin\""
echo "  (for Intel chip Mac) ln -sf \$DOT_DIR/etc/mac \"$(brew --prefix)/opt/findutils/libexec/gnubin\""
